...
/**
* Auto generated dao class by DAO-BUILDER: Mon Nov 27 10:08:02 GMT 2023
*/
public class ExampleConstants {
	...
	public static final String SELECT_BY_CODE = "SELECT * FROM "+ExampleConstants.TABLE_NAME+" WHERE NAME = :NAME";
