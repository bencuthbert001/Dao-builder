...
public class ExampleConstants {
	...
	public static final String INSERT_STATEMENT = "INSERT INTO EXAMPLE_TABLE(ID,NAME,SURNAME,CREATED) VALUES(:ID,:NAME,:SURNAME,:CREATED)";	public static final String UPDATE_STATEMENT = "UPDATE EXAMPLE_TABLE SET NAME = :NAME,SURNAME = :SURNAME,CREATED = :CREATED  WHERE ID =  :ID";
